...
public class DefaultConfigurationResolver implements ConfigurationResolver {
    ...
    public void resolveBuildDependencies(ConfigurationInternal configuration, ResolverResults result) {
        ...
        FileDependencyCollectingGraphVisitor fileDependenciesVisitor = new FileDependencyCollectingGraphVisitor(attributesFactory, buildOperationExecutor);
        DefaultResolvedArtifactsBuilder artifactsVisitor = new DefaultResolvedArtifactsBuilder(buildProjectDependencies, resolutionStrategy.getSortOrder(), buildOperationExecutor);
    ...
    public void resolveGraph(ConfigurationInternal configuration, ResolverResults results) {
        ...
        DefaultResolvedArtifactsBuilder artifactsBuilder = new DefaultResolvedArtifactsBuilder(buildProjectDependencies, configuration.getResolutionStrategy().getSortOrder(), buildOperationExecutor);
        FileDependencyCollectingGraphVisitor fileDependencyVisitor = new FileDependencyCollectingGraphVisitor(attributesFactory, buildOperationExecutor);
